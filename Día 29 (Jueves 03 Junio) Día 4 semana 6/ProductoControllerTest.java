...
class ProductoControllerTest {
	...
	void testVerProducto () {
		...
		Producto esperado= new Producto("Pan pita","Pan","Pan libre de manteca",200);//creado aca en el test
	...
	void testModificarProducto() {
		...
		int obtenido = a.modificarProducto("Pan pita","Pan","Pan libre de manteca",200);
		int esperado =1;
